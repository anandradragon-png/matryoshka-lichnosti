...
| `js/corp.js` 420, `js/organizer.js` 377, `js/account.js` 366 | Выше нормы 250, разбиение не согласовано |
| `js/practices-data.js` 351 | Файл данных, а не логики. Разбивать по категориям не надо: одна правка формата превратится в семь |
