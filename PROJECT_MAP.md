...
| Что | Состояние |
|---|---|
| `index.html` 654 строки, `styles.css` 778 | Выше нормы. Разбиение требует сборщика, которого в проекте намеренно нет |
| `js/corp.js` 420, `js/organizer.js` 346 | Выше нормы 250, разбиение не согласовано |
